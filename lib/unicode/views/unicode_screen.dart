...
import 'package:multitools/unicode/controllers/unicode_controller.dart';
import 'package:multitools/utils/route_custom_notifier.dart';

class UnicodeScreen extends HookConsumerWidget {
  const UnicodeScreen(
    this.routeObserver, {
    Key? key,
  }) : super(key: key);
  ...
  static const routeName = '/unicodescreen';

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final route = ModalRoute.of(context)! as PageRoute;
    final controller = UnicodeController();
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Unicode Encode/Decode'),
      ),
      body: Container(
